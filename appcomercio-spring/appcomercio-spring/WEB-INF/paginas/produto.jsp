...
<link href='<spring:url value="/resources/css/bootstrap.css"/>'
	rel="stylesheet" />
<script src='<spring:url value="/resources/js/jquery-3.5.0.js"/>'></script>
			...
			<div class="col-lg-9">
				...
				<form:form action="${salva}" modelAttribute="produto"
					...
					<div class="form-group">
						...
						<textarea rows="3" name="descricao" maxlength="2000"
					...
					<input type="submit" name="salva" class="btn btn-primary"
						value="${produto.id == 0 ? 'Cadastrar' : 'Alterar' }" />
						...
						<tbody>
							<c:forEach var="produto" items="${produtos}">
								<tr>
									...
									<td><a href="${altera}${produto.id}"
										class="btn btn-warning">Alterar</a></td>
									<td><a href="${deleta}${produto.id}"
